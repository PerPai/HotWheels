...
@Component({
  selector: 'app-categoria-dos',
  templateUrl: './categoria-dos.component.html',
  styleUrls: ['./categoria-dos.component.css'],
})
export class CategoriaDosComponent {
  filtro: any;
  ...
  filtrar(): void {
    this.filtro = { idArticulo: '', nombre: '', idCategoria: 2 };
