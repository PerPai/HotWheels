...
@Component({
  selector: 'app-categoria-cinco',
  templateUrl: './categoria-cinco.component.html',
  styleUrls: ['./categoria-cinco.component.css'],
})
export class CategoriaCincoComponent {
  filtro: any;
  ...
  filtrar(): void {
    this.filtro = { idArticulo: '', nombre: '', idCategoria: 5 };
