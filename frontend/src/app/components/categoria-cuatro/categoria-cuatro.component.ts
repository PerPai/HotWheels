...
@Component({
  selector: 'app-categoria-cuatro',
  templateUrl: './categoria-cuatro.component.html',
  styleUrls: ['./categoria-cuatro.component.css'],
})
export class CategoriaCuatroComponent {
  filtro: any;
  ...
  filtrar(): void {
    this.filtro = { idArticulo: '', nombre: '', idCategoria: 4 };
