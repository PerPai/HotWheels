...
@Component({
  selector: 'app-categoria-tres',
  templateUrl: './categoria-tres.component.html',
  styleUrls: ['./categoria-tres.component.css'],
})
export class CategoriaTresComponent {
  filtro: any;
  ...
  filtrar(): void {
    this.filtro = { idArticulo: '', nombre: '', idCategoria: 3 };
